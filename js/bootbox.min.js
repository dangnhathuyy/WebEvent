...
!(function (a, b) {
  ...
  var q = {
    bg_BG: {
      OK: 'ÄÂÄÂº',
      CANCEL: 'ÄÂĂ‘â€ÄÂºÄÂ°ÄÂ·',
      CONFIRM: 'ÄÅ¸ÄÂ¾Ă‘â€ÄÂ²Ă‘ÂĂ‘â‚¬ÄÂ¶ÄÂ´ÄÂ°ÄÂ²ÄÂ°ÄÂ¼',
    },
    br: { OK: 'OK', CANCEL: 'Cancelar', CONFIRM: 'Sim' },
    cs: { OK: 'OK', CANCEL: 'ZruĂ…Â¡it', CONFIRM: 'Potvrdit' },
    da: { OK: 'OK', CANCEL: 'Annuller', CONFIRM: 'Accepter' },
    de: { OK: 'OK', CANCEL: 'Abbrechen', CONFIRM: 'Akzeptieren' },
    el: {
      OK: 'Ăâ€¢ĂÂ½Ăâ€ĂÂ¬ĂÂ¾ĂÂµĂÂ¹',
      CANCEL: 'Ăâ€˜ĂÂºĂÂĂÂĂâ€°ĂÆ’ĂÂ·',
      CONFIRM: 'Ăâ€¢Ăâ‚¬ĂÂ¹ĂÂ²ĂÂµĂÂ²ĂÂ±ĂÂ¯Ăâ€°ĂÆ’ĂÂ·',
    },
    ...
    fa: {
      OK: 'Ă™â€Ă˜Â¨Ă™Ë†Ă™â€',
      CANCEL: 'Ă™â€Ă˜ÂºĂ™Ë†',
      CONFIRM: 'Ă˜ÂªĂ˜Â§Ă›Å’Ă›Å’Ă˜Â¯',
    },
    fi: { OK: 'OK', CANCEL: 'Peruuta', CONFIRM: 'OK' },
    fr: { OK: 'OK', CANCEL: 'Annuler', CONFIRM: "D'accord" },
    he: {
      OK: 'Ă—ÂĂ—â„¢Ă—Â©Ă—â€¢Ă—Â¨',
      CANCEL: 'Ă—â€˜Ă—â„¢Ă—ËœĂ—â€¢Ă—Å“',
      CONFIRM: 'Ă—ÂĂ—â„¢Ă—Â©Ă—â€¢Ă—Â¨',
    },
    hu: { OK: 'OK', CANCEL: 'MÄ‚Â©gsem', CONFIRM: 'MegerĂ…â€˜sÄ‚Â­t' },
    hr: { OK: 'OK', CANCEL: 'Odustani', CONFIRM: 'Potvrdi' },
    id: { OK: 'OK', CANCEL: 'Batal', CONFIRM: 'OK' },
    it: { OK: 'OK', CANCEL: 'Annulla', CONFIRM: 'Conferma' },
    ja: {
      OK: 'OK',
      CANCEL: 'Äƒâ€Â­ÄƒÆ’Â£ÄƒÆ’Â³Äƒâ€Â»ÄƒÆ’Â«',
      CONFIRM: 'Ă§Â¢ÂºĂ¨ÂªÂ',
    },
    lt: { OK: 'Gerai', CANCEL: 'AtĂ…Â¡aukti', CONFIRM: 'Patvirtinti' },
    lv: { OK: 'Labi', CANCEL: 'Atcelt', CONFIRM: 'ApstiprinĂ„Ât' },
    nl: { OK: 'OK', CANCEL: 'Annuleren', CONFIRM: 'Accepteren' },
    no: { OK: 'OK', CANCEL: 'Avbryt', CONFIRM: 'OK' },
    pl: { OK: 'OK', CANCEL: 'Anuluj', CONFIRM: 'PotwierdĂ…Âº' },
    pt: { OK: 'OK', CANCEL: 'Cancelar', CONFIRM: 'Confirmar' },
    ru: {
      OK: 'OK',
      CANCEL: 'ÄÂĂ‘â€ÄÂ¼ÄÂµÄÂ½ÄÂ°',
      CONFIRM: 'ÄÅ¸Ă‘â‚¬ÄÂ¸ÄÂ¼ÄÂµÄÂ½ÄÂ¸Ă‘â€Ă‘Å’',
    },
    sq: { OK: 'OK', CANCEL: 'Anulo', CONFIRM: 'Prano' },
    sv: { OK: 'OK', CANCEL: 'Avbryt', CONFIRM: 'OK' },
    th: {
      OK: 'Ă Â¸â€¢Ă Â¸ÂĂ Â¸Â¥Ă Â¸â€¡',
      CANCEL: 'Ă Â¸Â¢Ă Â¸ÂĂ Â¹â‚¬Ă Â¸Â¥Ă Â¸Â´Ă Â¸Â',
      CONFIRM: 'Ă Â¸Â¢Ă Â¸Â·Ă Â¸â„¢Ă Â¸Â¢Ă Â¸Â±Ă Â¸â„¢',
    },
    tr: { OK: 'Tamam', CANCEL: 'Ă„Â°ptal', CONFIRM: 'Onayla' },
    zh_CN: { OK: 'OK', CANCEL: 'Ă¥Ââ€“Ă¦Â¶Ë†', CONFIRM: 'Ă§Â¡Â®Ă¨Â®Â¤' },
    zh_TW: { OK: 'OK', CANCEL: 'Ă¥Ââ€“Ă¦Â¶Ë†', CONFIRM: 'Ă§Â¢ÂºĂ¨ÂªÂ' },
  }
  return (
