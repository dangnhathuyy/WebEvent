...
var SSO_URL_OAUTH_TOKEN_FACEBOOK_EXCHANGE =
  SSO_SERVER_URL + 'oauth/token/facebook/exchange'
var SSO_URL_OAUTH_TOKEN_VK_EXCHANGE =
  SSO_SERVER_URL + 'oauth/token/vk/exchange/v2'
var SSO_URL_OAUTH_TOKEN_LINE_EXCHANGE =
  SSO_SERVER_URL + 'oauth/token/line/exchange'
var SSO_URL_OAUTH_TOKEN_GOOGLE_EXCHANGE =
  SSO_SERVER_URL + 'oauth/token/google/exchange'
var SSO_URL_OAUTH_TOKEN_HUAWEI_EXCHANGE =
  SSO_SERVER_URL + 'oauth/token/huawei/exchange'
var SSO_URL_OAUTH_TOKEN_APPLE_EXCHANGE_WEB =
  SSO_SERVER_URL + 'oauth/token/apple/exchange/web'
var SSO_URL_OAUTH_TOKEN_TWITTER_EXCHANGE =
  SSO_SERVER_URL + 'oauth/token/twitter/exchange'
var SSO_URL_OAUTH_TWITTER_REQUEST_TOKEN =
  SSO_SERVER_URL + 'oauth/token/twitter/request_token'
...
var ACCOUNT_CENTER_RECOVERY_TEST_URL =
  'https://account.test.garena.com/recovery'
